...
if($link === false){
    ...
    $sql = "SELECT * FROM all_subjects WHERE dept_name ='Civil Department' AND semester = 'Semester-VI'";
    ...
    <section style="padding-bottom: 50px; padding-top: 150px;" id="services">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-10">
                    <div class="section-title text-center pb-10">
                        <h3 class="title">Civil Semester-VI</h3>
                ...
                <div class="card">
                    <div  class="single-features text-center card-body">
                        <div class="features-title-icon  justify-content-between">
                            <h4 class="features-title text-center"><a href="content_page/sem6/subject1/content_page.php"><?php echo $row['subject1'];?></a></h4>
                        </div>
                    </div>
                        ...
                        <div style="height: 80px;" class="card-footer border-0 text-center ">
                            <a href="content_page/sem6/subject1/content_page.php"><button style="border-radius: 50px; color: white;" type="button" class="btn btn-primary features-btn">EXPLORE MORE <img src="assets/images/arrow.png"></button></a>
                        </div>
                </div>
                <div class="card">
                    <div  class="single-features text-center card-body">
                        <div class="features-title-icon  justify-content-between">
                            <h4 class="features-title text-center"><a href="content_page/sem6/subject2/content_page.php"><?php echo $row['subject2'];?></a></h4>
                        </div>
                    </div>
                        <div class="single-features_sem features-content text-center">
                            <p class="text">Short description for the ones who look for something new. Short description for the ones who look for something new.</p>
                        ...
                        <div style="height: 80px;" class="card-footer border-0 text-center ">
                            <a href="content_page/sem6/subject2/content_page.php"><button style="border-radius: 50px; color: white;" type="button" class="btn btn-primary features-btn">EXPLORE MORE <img src="assets/images/arrow.png"></button></a>
                        </div>
                </div>
                <div class="card">
                    <div  class="single-features text-center card-body">
                        <div class="features-title-icon  justify-content-between">
                            <h4 class="features-title text-center"><a href="content_page/sem6/subject3/content_page.php"><?php echo $row['subject3'];?></a></h4>
                        </div>
                    </div>
                        <div class="single-features_sem features-content text-center">
                            <p class="text">Short description for the ones who look for something new. Short description for the ones who look for something new.</p>
                        ...
                        <div style="height: 80px;" class="card-footer border-0 text-center ">
                            <a href="content_page/sem6/subject3/content_page.php"><button style="border-radius: 50px; color: white;" type="button" class="btn btn-primary features-btn">EXPLORE MORE <img src="assets/images/arrow.png"></button></a>
                        </div>
                </div>
            </div>
            ...
            <div style="margin-top: 30px;" class="card-deck">
                <div class="card">
                    <div  class="single-features text-center card-body">
                        <div class="features-title-icon  justify-content-between">
                            <h4 class="features-title text-center"><a href="content_page/sem6/subject4/content_page.php"><?php echo $row['subject4'];?></a></h4>
                        </div>
                    </div>
                        <div class="single-features_sem features-content text-center">
                            <p class="text">Short description for the ones who look for something new. Short description for the ones who look for something new.</p>
                        ...
                        <div style="height: 80px;" class="card-footer border-0 text-center ">
                            <a href="content_page/sem6/subject4/content_page.php"><button style="border-radius: 50px; color: white;" type="button" class="btn btn-primary features-btn">EXPLORE MORE <img src="assets/images/arrow.png"></button></a>
                        </div>
                </div>
                <div class="card">
                    <div  class="single-features text-center card-body">
                        <div class="features-title-icon  justify-content-between">
                            <h4 class="features-title text-center"><a href="content_page/sem6/subject5/content_page.php"><?php echo $row['subject5'];?></a></h4>
                        </div>
                    </div>
                        <div class="single-features_sem features-content text-center">
                            <p class="text">Short description for the ones who look for something new. Short description for the ones who look for something new.</p>
                        ...
                        <div style="height: 80px;" class="card-footer border-0 text-center ">
                            <a href="content_page/sem6/subject5/content_page.php"><button style="border-radius: 50px; color: white;" type="button" class="btn btn-primary features-btn">EXPLORE MORE <img src="assets/images/arrow.png"></button></a>
                        </div>
                </div>
                <div class="card">
                    <div  class="single-features text-center card-body">
                        <div class="features-title-icon  justify-content-between">
                            <h4 class="features-title text-center"><a href="content_page/sem6/subject6/content_page.php"><?php echo $row['subject6'];?></a></h4>
                        </div>
                    </div>
                        <div class="single-features_sem features-content text-center">
                            <p class="text">Short description for the ones who look for something new. Short description for the ones who look for something new.</p>
                        ...
                        <div style="height: 80px;" class="card-footer border-0 text-center ">
                            <a href="content_page/sem6/subject6/content_page.php"><button style="border-radius: 50px; color: white;" type="button" class="btn btn-primary features-btn">EXPLORE MORE <img src="assets/images/arrow.png"></button></a>
                        </div>
                </div>
            </div>
            ...
            <div style="margin-top: 30px;" class="card-deck justify-content-center">
                <div style="background-color: #f4f6f7;" class="card col-lg-4 col-md-7 col-sm-9">
                    <div  class="single-features text-center card-body">
                        <div class="features-title-icon  justify-content-between">
                            <h4 class="features-title text-center"><a href="content_page/sem6/subject7/content_page.php"><?php echo $row['subject7'];?></a></h4>
                        </div>
                    </div>
                        <div class="single-features_sem features-content text-center">
                            <p class="text">Short description for the ones who look for something new. Short description for the ones who look for something new.</p>
                        ...
                        <div style="height: 80px; background-color: transparent;" class="card-footer border-0 text-center ">
                            <a href="content_page/sem6/subject7/content_page.php"><button style="border-radius: 50px; color: white;" type="button" class="btn btn-primary features-btn">EXPLORE MORE <img src="assets/images/arrow.png"></button></a>
                        </div>
                </div>
                <div style="background-color: #f4f6f7;" class="card col-lg-4 col-md-7 col-sm-9">
                    <div  class="single-features text-center card-body">
                        <div class="features-title-icon  justify-content-between">
                            <h4 class="features-title text-center"><a href="content_page/sem6/subject8/content_page.php"><?php echo $row['subject8'];?></a></h4>
                        </div>
                    </div>
                        <div class="single-features_sem features-content text-center">
                            <p class="text">Short description for the ones who look for something new. Short description for the ones who look for something new.</p>
                        ...
                        <div style="height: 80px; background-color: transparent;" class="card-footer border-0 text-center ">
                            <a href="content_page/sem6/subject8/content_page.php"><button style="border-radius: 50px; color: white;" type="button" class="btn btn-primary features-btn">EXPLORE MORE <img src="assets/images/arrow.png"></button></a>
                        </div>
                </div>
