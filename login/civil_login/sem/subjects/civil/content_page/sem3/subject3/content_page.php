...
if($link === false){
    ...
    $sql = "SELECT subject3 FROM all_subjects WHERE dept_name ='Civil Department' AND semester = 'Semester-III'";
...
//echo $row['option_value'];
    ...
    ?>
                        ...
                        <h3 style="font-weight: 600;" class="title"><?php echo $row['subject3'];?></h3>
