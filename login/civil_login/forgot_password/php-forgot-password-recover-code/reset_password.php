<?php
	if(isset($_POST["reset-password"])) {
		...
		$sql = "UPDATE `epiz_25699900_users`.`civil` SET `password` = '" . password_hash($_POST["password"], PASSWORD_DEFAULT). "' WHERE `civil`.`unique_id` = '" . $_GET["reset-code"] . "'";
...
<div class="row">
                                <div class="col-md-12 tex">
                                    <div class="single-form form-group">
                                        <input style="border-radius: 50px;" class="text-center" type="password" id="password" name="password" placeholder="Password" data-error="Password is required." required="required">
                                        <div class="help-block with-errors"></div>
                                    </div> <!-- single form -->
                                </div>
                                <div class="col-md-12">
                                    <div class="single-form form-group">
                                        <input style="border-radius: 50px;" class="text-center" type="password" name="confirm_password" id="confirm_password" placeholder="Confirm Password" data-error="Confirm Password is required." required="required">
                                        <div class="help-block with-errors"></div>
                                ...
                                <div class="col-md-12">
                                    <div class="single-form form-group text-center">
                                        <button type="submit" name="reset-password" id="reset-password" class="main-btn">Reset Password</button>
